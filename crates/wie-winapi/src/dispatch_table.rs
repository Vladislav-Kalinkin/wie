...
pub enum WinApiId {
    ...
    User32Createwindowexa = 109,
    User32Createwindowexw = 110,
...
pub fn dispatch_winapi_id(
    ...
    match id {
        ...
        WinApiId::User32Createwindowexa => user32::handle_create_window_ex_a(engine, state),
        WinApiId::User32Createwindowexw => user32::handle_create_window_ex_w(engine, state),
